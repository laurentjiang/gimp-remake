...
class GimpException : public std::exception {
  public:
     ...
     */
    explicit GimpException(ErrorInfo error) : error_info_(std::move(error)) {}
     ...
     */
    ErrorCode GetCode() const { return error_info_.GetCode(); }

    /**
     * @brief Get the error category
     * @return The error category
     */
    ErrorCategory GetCategory() const { return error_info_.GetCategory(); }
