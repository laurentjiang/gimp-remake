...
class ImageFile {
  public:
     ...
     * @param other The ImageFile to copy from.
     */
     ...
     *  @return OpenCV depth constant (e.g., CV_8U, CV_16U).
     */
